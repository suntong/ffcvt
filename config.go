...
type Options struct {
	...
	Speed      string // Speed up/down video playback speed (e.g. 1.25, 1.3 etc)
...
func initVars() {
	...
	flag.StringVar(&Opts.Speed, "Speed", "",
		"Speed up/down video playback speed (e.g. 1.25, 1.3 etc)")
